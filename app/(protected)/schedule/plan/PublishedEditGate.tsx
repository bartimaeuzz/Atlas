...
export function PublishedEditGate({
  ...
  return (
    <>
      {locked ? (
        <Card className="mb-6 flex flex-wrap items-center justify-between gap-4 !bg-[var(--warning-tint)] !border-[var(--warning-border)]">
          <p className="text-sm text-[var(--warning-700)]">
            This week is published — staff can already see it on their own My Schedule. You&apos;re
