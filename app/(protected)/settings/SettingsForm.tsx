      ...
      <fieldset>
        ...
        <label className="text-sm block">
          ...
          <input
            ...
            className={`border rounded-[var(--radius-md)] px-3 py-1.5 w-full max-w-sm min-h-11 ${DISABLED_FIELD}`}
          />
          ...
          <label className="text-sm block">
            ...
            <div className="relative w-32">
              <input
                ...
                className={`border rounded-[var(--radius-md)] pl-3 pr-6 py-1.5 w-full ${DISABLED_FIELD}`}
              />
          ...
          <label className="text-sm block">
            ...
            <div className="relative w-32">
              ...
              <input
                ...
                className={`border rounded-[var(--radius-md)] pl-6 pr-3 py-1.5 w-full ${DISABLED_FIELD}`}
              />
            </div>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <label className="text-sm block">
              ...
              <select
                ...
                className={`border rounded-[var(--radius-md)] px-3 py-1.5 w-full min-h-11 ${DISABLED_FIELD}`}
              >
            ...
            <label className="text-sm block">
              ...
              <div className="relative w-32">
                <input
                  ...
                  className={`border rounded-[var(--radius-md)] pl-3 pr-6 py-1.5 w-full min-h-11 ${DISABLED_FIELD}`}
                />
                <span className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[var(--ink-400)] text-sm pointer-events-none">
                  {packerStyle === "PERCENT" ? "%" : "$"}
                </span>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <label className="text-sm block">
            ...
            <input
              ...
              placeholder="not set"
              className={`border rounded-[var(--radius-md)] px-3 py-1.5 w-40 min-h-11 ${DISABLED_FIELD}`}
            />
            <span className="block text-xs text-[var(--ink-400)] mt-1">
          ...
          <label className="text-sm block">
            ...
            <div className="relative w-40">
              ...
              <input
                ...
                className={`border rounded-[var(--radius-md)] pl-6 pr-3 py-1.5 w-full min-h-11 ${DISABLED_FIELD}`}
              />
            </div>
            <span className="block text-xs text-[var(--ink-400)] mt-1">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {(
            ...
            <label key={f.name} className="text-sm block">
              ...
              <select name={f.name} defaultValue={f.value} className={`border rounded-[var(--radius-md)] px-3 py-1.5 w-full min-h-11 ${DISABLED_FIELD}`}>
